...
- Optional BoTorch Bayesian optimization helpers for single- and
  ...
  feasibility constraints, and diverse next-experiment batches.
...
| `matgpr.bayesian_optimization` | `suggest_next_experiments`, `suggest_multi_objective_next_experiments`, `observation_noise_variance`, `select_diverse_batch`, `CandidateConstraint` | Optional BoTorch finite-pool Bayesian optimization |

...
- Optional BoTorch Bayesian optimization helpers for ranking finite materials
  candidate pools, applying feasibility constraints, and selecting next
  experiments.
...
| `matgpr.bayesian_optimization` | `suggest_next_experiments`, `fit_botorch_surrogate`, `rank_discrete_candidates`, `CandidateConstraint` | Optional BoTorch finite-pool Bayesian optimization |
